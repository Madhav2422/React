...
function App() {
  ...
  const copypasswordtoClickboard = useCallback(() => {
    ...
    passwordRef.current?.setSelectionRange(0, 99); // To select the password range
  ...
  return (
    <>
      <div
       ...
       mx-auto shadow-md rounded-lg px-4 my-8 bg-gray-700"
      >
        ...
        <div className="flex text-sm-2 gap-x-2">
          ...
          <div className="flex items-center gap-x-1">
            ...
            />
            <label className="text-white" htmlFor="noinput">
              Number
            </label>
          </div>
          <div className="flex items-center gap-x-1">
